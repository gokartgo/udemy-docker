...
# kubectl run can use before 1.18 they are create all but after 1.18 this command create only pod if we want to create deployment must use kubectl creaete deployment <name> --image <image>
